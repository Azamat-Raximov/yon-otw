      ...
      <article className="pr-6 pb-12 animate-fade-in relative">
        ...
        <div className="mt-8">
          {isEditing ? (
            ...
            <div className="font-serif text-foreground/80 whitespace-pre-wrap break-words leading-relaxed text-lg overflow-hidden mr-48" style={{ wordBreak: 'break-word', overflowWrap: 'anywhere' }}>
